...
public class RessourceMaterielle extends Ressource  implements Serializable, Comparable<RessourceMaterielle> {
   ...
   // Initialiser à une chaîne vide par défaut
    ...
    public RessourceMaterielle(String n, String t, int qnt, double up) {
    ...
    @Override
    public int compareTo(RessourceMaterielle rm) {
        
        return this.getName().compareTo(rm.getName());
    }
